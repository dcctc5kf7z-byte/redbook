...
> **健康度**：V3.2 回归测试 67/67 PASS · V3.3 待回归测试 · 合规 🟢通过 · 108 条反馈
...
| **回归测试** | ✅ 已通过 | V3.0~V3.2 共 67/67 PASS · V3.3 待回归测试 |
...
- 执行 T1-T20 测试用例（拆解模式 10 条 + 挖掘模式 10 条）
- 执行 R1-R4 回归测试（基线不退化）
- 目标：20/20 PASS + 4/4 PASS
